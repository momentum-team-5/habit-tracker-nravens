...
# 5 views (list/detailed/add/update/delete view for user's habits)
# 5 views for all daily records for each habit
# View records for a habit by  date range (dictated by user)
# View records for a habit where the user did/did not meet goals? week-specific
# View records for 
